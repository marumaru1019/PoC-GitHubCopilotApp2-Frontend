  ...
  return (
    <ProtectedRoute>
      ...
      <div className="container py-8 max-w-3xl">
        <div className="mb-6">
          <h1 className="text-3xl font-bold tracking-tight">新規チケット作成</h1>
          <p className="text-muted-foreground mt-1">新しいサポートチケットを作成します</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-4">
                <Button
                  ...
                  className="flex-1"
                >
                  {createTicketMutation.isPending ? '作成中...' : 'チケットを作成'}
                </Button>
                <Button
                  type="button"
                  variant="outline"
